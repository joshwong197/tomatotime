    ...
    <header className="flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div className="flex gap-4 items-center">
        <div className="flex items-center bg-zinc-900/50 p-1 rounded-full border border-zinc-700/30">
          ...
          <button onClick={onToggleTheme} className="p-2 rounded-full text-zinc-500 hover:text-amber-400 transition-all" title={theme === 'dark' ? 'Switch to light mode' : 'Switch to dark mode'}>
            {theme === 'dark' ? (
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
